        ...
        <main>
            ...
            <article className="max-w-3xl mx-auto p-5">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <p className="font-extralight text-sm">Blog post by <span className="text-green-600">{post.author.name}</span> at {new Date(post._createdAt).toLocaleString()}</p>
                </div>
            ...
            {!submitted ? 
                (
                    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col p-5 my-10 max-w-2xl mx-auto mb-10">
                        ...
                        <input
                            type="Submit" className="shadow bg-yellow-500 hover:bg-yellow-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded cursor-pointer"
                        />
                    </form>
                ...
                (
                    <div className="flex flex-col p-10 my-10 bg-yellow-500 max-w-2xl mx-auto text-white">   
                        ...
                        <p>Once it has been approved, your comment will be shown here.</p>
                    </div>
                )
            }
